...
export class sync1670945289633 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "gmc_brand" ADD "info" character varying`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."gmc_product_refresh_reason_enum" RENAME TO "gmc_product_refresh_reason_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."gmc_product_refresh_reason_enum" AS ENUM('CREATED', 'STALE', 'PENDING', 'ADOPTED', 'MANUAL')`);
        await queryRunner.query(`ALTER TABLE "gmc_product" ALTER COLUMN "refresh_reason" TYPE "public"."gmc_product_refresh_reason_enum" USING "refresh_reason"::"text"::"public"."gmc_product_refresh_reason_enum"`);
        await queryRunner.query(`DROP TYPE "public"."gmc_product_refresh_reason_enum_old"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."gmc_product_refresh_reason_enum_old" AS ENUM('CREATED', 'STALE', 'PENDING', 'ADOPTED', 'MANUAL')`);
        await queryRunner.query(`ALTER TABLE "gmc_product" ALTER COLUMN "refresh_reason" TYPE "public"."gmc_product_refresh_reason_enum_old" USING "refresh_reason"::"text"::"public"."gmc_product_refresh_reason_enum_old"`);
        await queryRunner.query(`DROP TYPE "public"."gmc_product_refresh_reason_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."gmc_product_refresh_reason_enum_old" RENAME TO "gmc_product_refresh_reason_enum"`);
