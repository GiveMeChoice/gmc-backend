...
export class init1000000000001 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "merchant_brand" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "merchant_id" uuid NOT NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "logo_url" character varying, "info_link" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_7eacb2584c558add9c927fe06a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_33cf0608369fdc26eb1171794f" ON "merchant_brand" ("merchant_id", "code") `);
        ...
        await queryRunner.query(`CREATE TABLE "merchant_label" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "merchant_id" uuid NOT NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "logo" character varying, "url" character varying, "gmc_label_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_224dd583c61344852f31f1a0e84" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6ac7be85090976cfb4a4878684" ON "merchant_label" ("merchant_id", "code") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."region_enum" AS ENUM('uk')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9e5f0e09c22a21d435102bd6c3"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6ac7be85090976cfb4a4878684"`);
        await queryRunner.query(`DROP TABLE "merchant_label"`);
        await queryRunner.query(`DROP TABLE "gmc_label"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_33cf0608369fdc26eb1171794f"`);
