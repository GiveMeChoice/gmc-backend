...
export class init1000000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "gmc_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "providerId" "public"."pi_provider_id_enum" NOT NULL, "providerProductId" character varying NOT NULL, "shortId" character varying NOT NULL, "status" "public"."gmc_product_status_enum" NOT NULL, "statusAt" TIMESTAMP WITH TIME ZONE NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "productSourceId" character varying NOT NULL, "lastRefreshedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "lastRefreshedBy" character varying NOT NULL, "lastFoundAt" TIMESTAMP WITH TIME ZONE NOT NULL, "lastFoundBy" character varying NOT NULL, "sku" character varying, "title" character varying, "description" character varying, "rating" numeric(3,2), "ratingsTotal" integer, "price" numeric(10,2), "currency" character varying, "brandId" character varying, "brandName" character varying, "image" character varying, "link" character varying, "createdBySourceRunId" character varying, CONSTRAINT "UQ_1f99bf5eb222ffba56d56b7d19a" UNIQUE ("shortId"), CONSTRAINT "PK_6e0408e4e723f1bb1f080b26cd8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
