...
export class init1000000000001 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."pi_provider_key_enum" AS ENUM('rainforest-api', 'ethical-superstore-web', 'kelkoo', 'tesco')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_70e7dd4d9302802b787ee69103" ON "merchant_category" ("merchant_id", "merchant_category_code") `);
        await queryRunner.query(`CREATE TABLE "gmc_label" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying, "nsleft" integer NOT NULL DEFAULT '1', "nsright" integer NOT NULL DEFAULT '2', "parentId" uuid, CONSTRAINT "PK_5ce50b41965194384818bf3ae6a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "merchant_label" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "merchant_id" uuid NOT NULL, "merchant_label_code" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "logo" character varying, "url" character varying, "gmc_label_id" uuid, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_224dd583c61344852f31f1a0e84" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ab358abf21829182c038ccb892" ON "merchant_label" ("merchant_id", "merchant_label_code") `);
        await queryRunner.query(`CREATE TABLE "product_review" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "author" character varying NOT NULL, "text" character varying NOT NULL, "rating" numeric(3,2), "submitted_on" TIMESTAMP WITH TIME ZONE NOT NULL, "productId" uuid, CONSTRAINT "PK_6c00bd3bbee662e1f7a97dbce9a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."product_image_type_enum" AS ENUM('LIST', 'DETAIL')`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "short_id" character varying NOT NULL, "channel_id" character varying NOT NULL, "merchant_id" uuid NOT NULL, "merchant_product_code" character varying NOT NULL, "product_status" "public"."product_status_enum" NOT NULL, "created_by_run_id" character varying NOT NULL, "refreshed_by_run_id" character varying, "refreshed_at" TIMESTAMP WITH TIME ZONE, "product_refresh_reason" "public"."product_refresh_reason_enum", "source_date" TIMESTAMP WITH TIME ZONE, "expires_at" TIMESTAMP WITH TIME ZONE, "keep_alive_count" integer NOT NULL DEFAULT '0', "error_message" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "sku" character varying, "title" character varying, "description" character varying, "rating" numeric(3,2), "ratings_total" integer, "price" numeric(10,2), "shipping_price" numeric(10,2), "currency" character varying, "list_image" character varying, "main_image" character varying, "secondary_image" character varying, "offer_url" character varying, "source_id" uuid, "merchantBrandId" uuid, "merchantCategoryId" uuid, CONSTRAINT "UQ_3c1788393d3c93fb6c0461b8846" UNIQUE ("short_id"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_172f81328f0ee926a88eca8b79" ON "product" ("merchant_id", "merchant_product_code") `);
        await queryRunner.query(`CREATE TABLE "merchant_brand" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "merchant_id" uuid NOT NULL, "merchant_brand_code " character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "logo" character varying, "url" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_7eacb2584c558add9c927fe06a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_5a6d0c9c7f661e307619ead1d2" ON "merchant_brand" ("merchant_id", "merchant_brand_code ") `);
        await queryRunner.query(`CREATE TYPE "public"."merchant_key_enum" AS ENUM('amazon-uk', 'ethical-superstore')`);
        await queryRunner.query(`CREATE TYPE "public"."region_enum" AS ENUM('UK', 'US', 'NL')`);
        ...
        await queryRunner.query(`ALTER TABLE "merchant_label" ADD CONSTRAINT "FK_9fe95ce2938a1edc8ea51b06e67" FOREIGN KEY ("merchant_id") REFERENCES "merchant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "merchant_label" ADD CONSTRAINT "FK_a77a196582cd0ca731db517fb80" FOREIGN KEY ("gmc_label_id") REFERENCES "gmc_label"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_c210304b89037da478d036e047e" FOREIGN KEY ("source_id") REFERENCES "pi_channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_189ace3fc691f857a4abaee6203" FOREIGN KEY ("merchant_id") REFERENCES "merchant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_98a8141123dc221268ebe1582c7" FOREIGN KEY ("merchantBrandId") REFERENCES "merchant_brand"("id") ON DELETE NO ACTION ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "product" ADD CONSTRAINT "FK_b99bdf8ff33eb34c9951bfddcc3" FOREIGN KEY ("merchantCategoryId") REFERENCES "merchant_category"("id") ON DELETE NO ACTION ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "pi_channel" ADD CONSTRAINT "FK_2eeaf7850b473fcd0a7e876c222" FOREIGN KEY ("merchant_id") REFERENCES "merchant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "pi_channel" ADD CONSTRAINT "FK_635313b70b91d6e77b70149430d" FOREIGN KEY ("provider_id") REFERENCES "pi_provider"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pi_channel" DROP CONSTRAINT "FK_635313b70b91d6e77b70149430d"`);
        await queryRunner.query(`ALTER TABLE "pi_channel" DROP CONSTRAINT "FK_2eeaf7850b473fcd0a7e876c222"`);
        await queryRunner.query(`ALTER TABLE "merchant_brand" DROP CONSTRAINT "FK_c83440bec55cf33348e8f3d4ea5"`);
        await queryRunner.query(`ALTER TABLE "product" DROP CONSTRAINT "FK_b99bdf8ff33eb34c9951bfddcc3"`);
        await queryRunner.query(`ALTER TABLE "product" DROP CONSTRAINT "FK_98a8141123dc221268ebe1582c7"`);
        await queryRunner.query(`ALTER TABLE "product" DROP CONSTRAINT "FK_189ace3fc691f857a4abaee6203"`);
        await queryRunner.query(`ALTER TABLE "product" DROP CONSTRAINT "FK_c210304b89037da478d036e047e"`);
        ...
        await queryRunner.query(`ALTER TABLE "merchant_label" DROP CONSTRAINT "FK_a77a196582cd0ca731db517fb80"`);
        await queryRunner.query(`ALTER TABLE "merchant_label" DROP CONSTRAINT "FK_9fe95ce2938a1edc8ea51b06e67"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_5a6d0c9c7f661e307619ead1d2"`);
        await queryRunner.query(`DROP TABLE "merchant_brand"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_172f81328f0ee926a88eca8b79"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ab358abf21829182c038ccb892"`);
        await queryRunner.query(`DROP TABLE "merchant_label"`);
        await queryRunner.query(`DROP TABLE "gmc_label"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_70e7dd4d9302802b787ee69103"`);
