...
export class init1000000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "gmc_category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying NOT NULL, "name" character varying NOT NULL, "color" character varying, "description" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "nsleft" integer NOT NULL DEFAULT '1', "nsright" integer NOT NULL DEFAULT '2', "parentId" uuid, CONSTRAINT "PK_692bf98e94dc833f6a6f4a18874" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "gmc_label" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying NOT NULL, "name" character varying NOT NULL, "color" character varying, "description" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "nsleft" integer NOT NULL DEFAULT '1', "nsright" integer NOT NULL DEFAULT '2', "parentId" uuid, CONSTRAINT "PK_5ce50b41965194384818bf3ae6a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "pi_channel" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "provider_id" uuid NOT NULL, "merchant_id" uuid NOT NULL, "name" character varying NOT NULL, "status" "public"."pi_channel_status_enum" NOT NULL DEFAULT 'READY', "active" boolean NOT NULL DEFAULT false, "run_interval_hours" integer NOT NULL DEFAULT '0', "expiration_hours" integer NOT NULL DEFAULT '0', "retry_limit" integer NOT NULL DEFAULT '4', "retry_count" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_run_at" TIMESTAMP WITH TIME ZONE, "ETL_CODE_1" character varying, "ETL_CODE_2" character varying, "ETL_CODE_3" character varying, "ETL_CODE_4" character varying, "ETL_CODE_5" character varying, CONSTRAINT "PK_88cbcdff12b371d63af212d4ff3" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "gmc_brand" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying NOT NULL, "name" character varying NOT NULL, "description" character varying, "logo" character varying, "url" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_bfbb245c9727f8a8b1394056057" UNIQUE ("slug"), CONSTRAINT "PK_b43e8521fc9a91b02f58d23f251" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD CONSTRAINT "FK_7d69dcc5b9a8c81313cfda62ddf" FOREIGN KEY ("merchant_brand_id") REFERENCES "merchant_brand"("id") ON DELETE NO ACTION ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD CONSTRAINT "FK_901c5d835b4f1699f6d567edfa1" FOREIGN KEY ("merchant_category_id") REFERENCES "merchant_category"("id") ON DELETE NO ACTION ON UPDATE CASCADE`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" DROP CONSTRAINT "FK_901c5d835b4f1699f6d567edfa1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" DROP CONSTRAINT "FK_7d69dcc5b9a8c81313cfda62ddf"`,
    );
    await queryRunner.query(
